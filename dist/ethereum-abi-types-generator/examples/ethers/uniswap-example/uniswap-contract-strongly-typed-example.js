...
var customHttpProvider = new ethers_1.ethers.providers.JsonRpcProvider('https://mainnet.infura.io/v3/280bb5b627394709938a7cc0b71a4a58');
var UniswapStronglyTypedExample = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, contractWithSigner.ethToTokenSwapInput(minTokens, this.generateTradeDeadlineUnixTime(), { value: ethers_1.utils.parseEther(ethAmount.toString()) })];
                    case 2:
                        tx = _a.sent();
    ...
    UniswapStronglyTypedExample.prototype.getTokenContract = function (erc20TokenContract) {
        ...
        return new ethers_1.ethers.Contract(erc20TokenContract, abi_examples_1.AbiExamples.tokenAbi, customHttpProvider);
    };
    /**
    ...
    UniswapStronglyTypedExample.prototype.getExchangeContractForTokenByExchangeAddress = function (exchangeAddress) {
        ...
        return new ethers_1.ethers.Contract(exchangeAddress, abi_examples_1.AbiExamples.uniswapExchangeAbi, customHttpProvider);
    };
    /**
    ...
    UniswapStronglyTypedExample.prototype.buildUniswapFactoryContract = function () {
        ...
        return new ethers_1.ethers.Contract(abi_examples_1.AbiExamples.uniswapFactoryAddress, abi_examples_1.AbiExamples.uniswapFactoryAbi, customHttpProvider);
    };
    /**
...
var example = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ethAmount = ethers_1.ethers.utils.parseEther('0.01');
            ...
            case 2:
                ...
                return [4 /*yield*/, uniswap.trade(ethAmount, new utils_1.BigNumber('900'))];
            case 3:
