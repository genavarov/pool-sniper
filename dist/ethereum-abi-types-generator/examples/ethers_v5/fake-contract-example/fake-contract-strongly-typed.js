    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                customHttpProvider = new ethersv5_1.ethers.providers.JsonRpcProvider('https://mainnet.infura.io/v3/280bb5b627394709938a7cc0b71a4a58');
                contract = new ethersv5_1.ethers.Contract(abi_examples_1.AbiExamples.YOUR_CONTRACT_ADDRESS, abi_examples_1.AbiExamples.YOUR_ABI, customHttpProvider);
            ...
            case 1:
                ...
                return [4 /*yield*/, contractWithSigner.tupleInputOnly(tupleExampleRequest, {
                        ...
                        gasPrice: ethersv5_1.utils.parseUnits('9.0', 'gwei'),
                        // The nonce to use in the transaction
                        nonce: 123,
                        // The amount to send with the transaction (i.e. msg.value)
                        value: ethersv5_1.utils.parseEther('1.0'),
