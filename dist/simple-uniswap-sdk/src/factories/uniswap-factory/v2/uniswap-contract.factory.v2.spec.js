...
describe('UniswapContractFactoryV2', function () {
    var ethersProvider = new ethers_provider_1.EthersProvider({ chainId: __1.ChainId.MAINNET });
    var uniswapContractFactory = new uniswap_contract_factory_v2_1.UniswapContractFactoryV2(ethersProvider);
    it('allPairs', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.allPairs('0x01')];
                case 1:
                    result = _a.sent();
    ...
    it('allPairsLength', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.allPairsLength()];
                case 1:
                    result = _a.sent();
    ...
    it('createPair', function () {
        var result = uniswapContractFactory.createPair((0, fun_token_mock_1.MOCKFUN)().contractAddress, __1.WETHContract.MAINNET().contractAddress);
    ...
    it('feeTo', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.feeTo()];
                case 1:
                    result = _a.sent();
                    expect((0, utils_1.isHexString)(result)).toEqual(true);
                    return [2 /*return*/];
    ...
    it('feeToSetter', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.feeToSetter()];
                case 1:
                    result = _a.sent();
                    expect((0, utils_1.isHexString)(result)).toEqual(true);
                    return [2 /*return*/];
    ...
    it('getPair', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.getPair(__1.WETHContract.MAINNET().contractAddress, (0, fun_token_mock_1.MOCKFUN)().contractAddress)];
                case 1:
                    result = _a.sent();
    ...
    it('setFeeTo', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.setFeeTo('0x05B0c1D8839eF3a989B33B6b63D3aA96cB7Ec142')];
                case 1:
                    result = _a.sent();
    ...
    it('setFeeToSetter', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uniswapContractFactory.setFeeToSetter('0x05B0c1D8839eF3a989B33B6b63D3aA96cB7Ec142')];
                case 1:
                    result = _a.sent();
...
//# sourceMappingURL=uniswap-contract.factory.v2.spec.js.map